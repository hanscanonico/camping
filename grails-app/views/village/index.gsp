		...
		<div id="list-village" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nom" title="${message(code: 'village.nom.label', default: 'Nom')}" />
					
						<th><g:message code="village.pays.label" default="Pays" /></th>
				...
				<g:each in="${villageInstanceList}" status="i" var="villageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${villageInstance.id}">${fieldValue(bean: villageInstance, field: "nom")}</g:link></td>
					
						<td>${fieldValue(bean: villageInstance, field: "pays")}</td>
			...
			<div class="pagination">
				<g:paginate total="${villageInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
