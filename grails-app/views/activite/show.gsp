	...
	<body>
		...
		<div id="show-activite" class="content scaffold-show" role="main">
			...
			<ol class="property-list activite">
				...
				<g:if test="${activiteInstance?.designatic}">
				<li class="fieldcontain">
					<span id="designatic-label" class="property-label"><g:message code="activite.designatic.label" default="Designatic" /></span>
					
						<span class="property-value" aria-labelledby="designatic-label"><g:fieldValue bean="${activiteInstance}" field="designatic"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${activiteInstance?.proposer}">
				<li class="fieldcontain">
					<span id="proposer-label" class="property-label"><g:message code="activite.proposer.label" default="Proposer" /></span>
