		...
		<div id="list-activite" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="designatic" title="${message(code: 'activite.designatic.label', default: 'Designatic')}" />
				...
				<g:each in="${activiteInstanceList}" status="i" var="activiteInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${activiteInstance.id}">${fieldValue(bean: activiteInstance, field: "designatic")}</g:link></td>
